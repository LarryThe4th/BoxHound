...
public class bl_IndicatorManager : MonoBehaviour {
    ...
    /// <summary>
    /// If have a indicator of a same sender and this is avaible yet.
    ...
    /// <summary>
    /// Controll direction od each Indicator in List
    /// </summary>
    void ControllIndicators()
    {
        for(int i = 0; i < IndicatorsEntrys.Count; i++)
        {
            ...
            //get the horinzontal angle in direction of target / sender.
